...
|---|---|---|
| **Apex** | Salesforce's backend language: data model, SOQL/DML, triggers, governor limits, async, testing, integration | [Salesforce_Apex_From_Scratch/](./Salesforce_Apex_From_Scratch/) |
| **LWC** | Lightning Web Components: the modern Salesforce UI framework (HTML/JS/CSS, reactivity, Apex wiring, Jest) | [Salesforce_LWC_From_Scratch/](./Salesforce_LWC_From_Scratch/) |
| **Data Cloud** | Salesforce's CDP (a.k.a. Data 360): data streams, DLO/DMO, identity resolution, insights, segmentation, activation | [Salesforce_Data_Cloud_From_Scratch/](./Salesforce_Data_Cloud_From_Scratch/) |
| **Agentforce** | Salesforce's agentic AI platform: agents, topics, actions, the Atlas Reasoning Engine, grounding, the Trust Layer | [Salesforce_Agentforce_From_Scratch/](./Salesforce_Agentforce_From_Scratch/) |
